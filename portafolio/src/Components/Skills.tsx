...
export default function Skills() {
    return (
        <section className="text-gray-400 w-full flex m-auto space-x-9 justify-center flex-wrap">
            <div className="p-4 flex flex-wrap bg-gray-900 bg-opacity-80 w-[40%] border-2 rounded-lg">
